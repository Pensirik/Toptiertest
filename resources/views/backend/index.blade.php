...
.card_color {
    ...
    position: relative;
    color: #fff;
    background-image: url(https://i.imgur.com/5rm6bLu.jpg);
    z-index: 5;
...
.card_color::before {
    ...
    background: linear-gradient(90deg, rgba(63, 94, 251, 1) 0%, rgba(240, 50, 89, 1) 100%);
    opacity: 0.8
}
...
.card_color::after {
    ...
    background: rgb(63, 94, 251);
    background: linear-gradient(90deg, rgba(63, 94, 251, 1) 0%, rgba(240, 50, 89, 1) 100%);
    clip-path: polygon(28% 13%, 48% 45%, 75% 63%, 100% 99%, 0 100%, 0% 60%, 0 0)
}
.upper {
    display: flex;
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-6 mb-4">
            <div class="card_color card bg-success text-white shadow">
                <div class="card-body upper">
                     <h5> <i class="fa fa-credit-card" aria-hidden="true"></i> Balance</h5>
                    <div class="h3 mb-0 mr-3 font-weight-bold text-white-800"> {{ number_format($balance['total']/100,2) }} Baht </div>
               
                </div>
            </div>
        </div>
        <div class="col-6 mb-4">
            <div class="card_color card bg-info text-white shadow">
                <div class="card-body upper">
                    <h5> <i class="fa fa fa-university" aria-hidden="true"></i> Transferable</h5>
                    <div class="h3 mb-0 mr-3 font-weight-bold text-white-800"> {{ number_format($balance['transferable']/100,2) }} Baht </div>
                </div>
            </div>
        </div>
      </div>
                      ...
                      yAxes: [{
                        ticks: {
                          ...
                          callback: function(value, index, values) {
                            return '' + number_format(value)+ ' Baht';
                          }
                        },
                        gridLines: {
                    ...
                    tooltips: {
                      ...
                      callbacks: {
                        label: function(tooltipItem, chart) {
                          ...
                          return datasetLabel + ': ' + number_format(tooltipItem.yLabel) + ' Baht';
                        }
                      }
                    }
                  }
